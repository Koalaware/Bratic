...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "Hey! I'm a chill app developer (Hellstrap, Voidstrap, Plexity) with a dream to help people. Let’s talk!"
  ];
  let bioText = '';
  let bioIndex = 0;
  ...
  function initMedia() {
    ...
    const hackerVideo = document.getElementById('hacker-video');
    ...
    homeVideo.volume = volumeSlider.value;
    hackerVideo.volume = volumeSlider.value;
    rainVideo.volume = volumeSlider.value;
    animeVideo.volume = volumeSlider.value;
    carVideo.volume = volumeSlider.value;
    homeVideo.play();
...
const themes = {
    ...
    'hacker-theme': {
        videoId: 'hacker-video',
        musicId: 'hacker-music',
        overlay: 'hacker-overlay',
        primaryColor: '#22C55E',
...
function switchTheme(themeClass) {
    ...
    homeVideo.classList.add('hidden');
    hackerVideo.classList.add('hidden');
    rainVideo.classList.add('hidden');
    animeVideo.classList.add('hidden');
    carVideo.classList.add('hidden');

    const theme = themes[themeClass];

    const currentVideo = document.getElementById(theme.videoId);
...
document.getElementById('home-theme').addEventListener('click', () => switchTheme('home-theme'));
document.getElementById('hacker-theme').addEventListener('click', () => switchTheme('hacker-theme'));
document.getElementById('rain-theme').addEventListener('click', () => switchTheme('rain-theme'));
document.getElementById('anime-theme').addEventListener('click', () => switchTheme('anime-theme'));
document.getElementById('car-theme').addEventListener('click', () => switchTheme('car-theme'));
